...
export const LostAndFoundListPage: React.FC = () => {
  const {
    items,
    loading,
    createItem,
  ...
  const handleReturnItem = async () => {
    if (selectedItem && returnName.trim()) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-end gap-2">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-3 py-2.5 bg-slate-200 dark:bg-slate-700 hover:bg-slate-300 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-200 text-sm font-medium rounded-xl transition-all duration-200"
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full max-w-md border border-slate-200 dark:border-slate-700">
            ...
            <div className="flex justify-end gap-3 p-6 pt-0">
              ...
              <button
                ...
                className="px-4 py-2 text-sm font-semibold rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white disabled:opacity-40 transition-all"
